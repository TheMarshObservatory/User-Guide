...
The dome must be powered on manually, using the switch on the wall of the telescope room (see Figure \ref{fig:domepower}. Turn it anti-clockwise to the horizontal position to enable power, then return to the control computer.
...
and power off by rotating the switch on the wall clockwise into the vertical position.
